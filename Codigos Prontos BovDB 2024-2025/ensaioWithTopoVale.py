...
def main(df, n_gen=1000, pop_size=20):
...
query = """
    ...
    FROM price5
    WHERE id_ticker = 58413 AND date BETWEEN '2024-01-01' AND '2024-02-14';
"""
...
'''
unique_dates = df_5min.index.date

for single_date in unique_dates:
    daily_data = df_5min[df_5min.index.date == single_date]
    if not daily_data.empty:
        plot_candlestick_with_bollinger(daily_data)
'''
